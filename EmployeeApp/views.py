...
from EmployeeApp.models import Departments, Employees,Users,Projects
from EmployeeApp.serializers import DeparmentSerializer, EmployeeSerializer,ProjectSerializer,UserSerializer
...
@csrf_exempt
def ProjectDomain(request,project_domain=''):
  if request.method == 'GET':
    projects = Projects.objects.get(ProjectDomain=project_domain)
    projects_serializer = ProjectSerializer(projects,many=True)
    return JsonResponse(projects_serializer.data,safe=False)
